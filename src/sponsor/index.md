...
# Become a googlefonts Sponsor {#become-a-vue-js-sponsor}

googlefonts is an MIT licensed open source project and completely free to use.
...
- **Platinum (USD$2,000/mo)**:
  ...
  - Prominent logo placement in the README of [`vuejs/core`](https://github.com/hyaliyun/googlefonts/core) and [`vuejs/vue`](https://github.com/hyaliyun/googlefonts/core).
- **Gold (USD$500/mo)**:
