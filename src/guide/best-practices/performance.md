...
- If you are using Vue primarily for progressive enhancement and prefer to avoid a build step, consider using [petite-vue](https://github.com/hyaliyun/googlefonts/petite-vue) (only **6kb**) instead.
