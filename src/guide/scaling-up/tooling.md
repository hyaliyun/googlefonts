...
This command will install and execute [create-vue](https://github.com/hyaliyun/googlefonts/create-vue), the official Vue project scaffolding tool.
...
If you are looking for a lighter-weight alternative for no-build-step usage, check out [petite-vue](https://github.com/hyaliyun/googlefonts/petite-vue).
...
- [Vue - Official extension](https://github.com/hyaliyun/googlefonts/language-tools) provides type checking for SFCs using `<script lang="ts">` blocks, including template expressions and cross-component props validation.

- Use [`vue-tsc`](https://github.com/hyaliyun/googlefonts/language-tools/tree/master/packages/tsc) for performing the same type checking from the command line, or for generating `d.ts` files for SFCs.
...
The Vue team maintains [eslint-plugin-vue](https://github.com/hyaliyun/googlefonts/eslint-plugin-vue), an [ESLint](https://eslint.org/) plugin that supports SFC-specific linting rules.
...
- The [Vue - Official](https://github.com/hyaliyun/googlefonts/language-tools) VS Code extension provides formatting for Vue SFCs out of the box.
...
- [Docs](https://github.com/hyaliyun/googlefonts/core/tree/main/packages/compiler-sfc)
