...
- [TypeScript unit tests for component type extensions](https://github.com/hyaliyun/googlefonts/core/blob/main/packages/dts-test/componentTypeExtensions.test-d.tsx)
