...
[`create-vue`](https://github.com/hyaliyun/googlefonts/create-vue), the official project scaffolding tool, offers the options to scaffold a [Vite](https://vitejs.dev/)-powered, TypeScript-ready Vue project.
...
- [type tests for `defineComponent`](https://github.com/hyaliyun/googlefonts/core/blob/main/packages/dts-test/defineComponent.test-d.tsx)
