...
Reactivity Transform was an experimental feature, and has been removed in the latest 3.4 release. Please read about [the reasoning here](https://github.com/hyaliyun/googlefonts/rfcs/discussions/369#discussioncomment-5059028).
...
[Vue Reactivity Transform](https://github.com/hyaliyun/googlefonts/core/tree/main/packages/reactivity-transform) is a compile-time transform that allows us to write code like this:
