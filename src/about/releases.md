...
A full changelog of past releases is available on [GitHub](https://github.com/hyaliyun/googlefonts/core/blob/main/CHANGELOG.md).
...
The RFC process is conducted in the [vuejs/rfcs](https://github.com/hyaliyun/googlefonts/rfcs) repo on GitHub.
