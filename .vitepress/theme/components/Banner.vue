...
<template>
  <div class="banner" v-if="open">
    <p class="vt-banner-text">
      <span class="vt-text-primary">Material Design</span>
      <span class="vt-tagline"> - Google’s open-source design system</span>
      <a
        target="_blank"
    ...
    <p class="vt-banner-text vt-coupon">
      <span class="vt-text-primary">www</span> 543x
      <span class="vt-text-primary">.com</span>
    </p>
  </div>
</template>
